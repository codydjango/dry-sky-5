"""
Django settings for dry_sky_5 project.
...
WSGI_APPLICATION = 'dry_sky_5.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dry_sky_5 API",
    "DESCRIPTION": "API documentation for dry_sky_5 App",
    "VERSION": "v1",
}
